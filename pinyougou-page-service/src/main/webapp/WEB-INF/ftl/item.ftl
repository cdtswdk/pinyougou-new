...
<body ng-app="pinyougou" ng-controller="itemController" ng-init="loadSku();num=1">
<#--引入页面头部-->
<#include "head.ftl">
                        ...
                        <#list specificationList as spec>
                            <dl>
                                ...
                                <#list spec.attributeValue as attr>
                                    <dd>
                                        <a class="{{isSelected('${spec.attributeName}','${attr}')?'selected':''}}"
                                           href="javascript:;"
                                           ng-click="selectSpecList('${spec.attributeName}','${attr}')">
                                            ${attr}
